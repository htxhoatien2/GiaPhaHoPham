...
export const CLAN_NAME = process.env.NEXT_PUBLIC_CLAN_NAME || 'Họ Phạm Văn';

// Full clan name with location (e.g. "Họ Đặng làng Kỷ Các")
export const CLAN_FULL_NAME = process.env.NEXT_PUBLIC_CLAN_FULL_NAME || 'Họ Phạm Văn làng An Trạch';

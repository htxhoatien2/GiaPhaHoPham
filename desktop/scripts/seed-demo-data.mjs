...
async function seed() {
  ...
  const people = [
    // Đời 1: Thủy tổ
    { id: 'bbbbbbbb-0001-4000-b000-000000000001', handle: 'pham-van-thuy-to', display_name: 'Phạm Văn Thủy Tổ', first_name: 'Thủy Tổ', surname: 'Phạm', gender: 1, generation: 1, is_living: false, birth_year: 1850, death_year: 1920, death_lunar: '12/3', biography: 'Thủy tổ dòng họ Phạm Văn làng An Trạch.', privacy_level: 0, is_patrilineal: true },
    ...
    // Đời 2: 3 con + 2 dâu
    { id: 'bbbbbbbb-0011-4000-b000-000000000011', handle: 'pham-van-nhat', display_name: 'Phạm Văn Nhất', first_name: 'Nhất', surname: 'Phạm', gender: 1, generation: 2, is_living: false, birth_year: 1880, death_year: 1950, death_lunar: '15/1', biography: 'Con trưởng.', privacy_level: 0, is_patrilineal: true },
    ...
    { id: 'bbbbbbbb-0013-4000-b000-000000000013', handle: 'pham-van-nhi', display_name: 'Phạm Văn Nhị', first_name: 'Nhị', surname: 'Phạm', gender: 1, generation: 2, is_living: false, birth_year: 1883, death_year: 1955, death_lunar: '5/11', biography: 'Con thứ.', privacy_level: 0, is_patrilineal: true },
    ...
    { id: 'bbbbbbbb-0015-4000-b000-000000000015', handle: 'pham-thi-ba', display_name: 'Phạm Thị Ba', first_name: 'Ba', surname: 'Phạm', gender: 2, generation: 2, is_living: false, birth_year: 1886, death_year: 1970, death_lunar: '3/6', biography: 'Con gái út.', privacy_level: 0, is_patrilineal: true },
    // Đời 3: 4 cháu
    { id: 'bbbbbbbb-0021-4000-b000-000000000021', handle: 'pham-van-tai', display_name: 'Phạm Văn Tài', first_name: 'Tài', surname: 'Phạm', gender: 1, generation: 3, is_living: false, birth_year: 1910, death_year: 1980, death_lunar: '18/2', biography: 'Cháu trưởng.', privacy_level: 0, is_patrilineal: true },
    { id: 'bbbbbbbb-0022-4000-b000-000000000022', handle: 'nguyen-thi-hoa', display_name: 'Nguyễn Thị Hoa', first_name: 'Hoa', surname: 'Nguyễn', gender: 2, generation: 3, is_living: false, birth_year: 1915, death_year: 1990, death_lunar: '7/10', biography: 'Vợ ông Tài.', privacy_level: 0, is_patrilineal: false },
    { id: 'bbbbbbbb-0023-4000-b000-000000000023', handle: 'pham-thi-lien', display_name: 'Phạm Thị Liên', first_name: 'Liên', surname: 'Phạm', gender: 2, generation: 3, is_living: false, birth_year: 1912, death_year: 1985, death_lunar: '25/8', biography: 'Con gái ông Nhất.', privacy_level: 0, is_patrilineal: true },
    { id: 'bbbbbbbb-0024-4000-b000-000000000024', handle: 'pham-van-duc', display_name: 'Phạm Văn Đức', first_name: 'Đức', surname: 'Phạm', gender: 1, generation: 3, is_living: false, birth_year: 1915, death_year: 1988, death_lunar: '10/5', biography: 'Con ông Nhị.', privacy_level: 0, is_patrilineal: true },
    // Đời 4: 4 chắt (còn sống)
    { id: 'bbbbbbbb-0031-4000-b000-000000000031', handle: 'pham-van-minh', display_name: 'Phạm Văn Minh', first_name: 'Minh', surname: 'Phạm', gender: 1, generation: 4, is_living: true, birth_year: 1945, biography: 'Trưởng nam đời 4.', privacy_level: 0, is_patrilineal: true },
    ...
    { id: 'bbbbbbbb-0033-4000-b000-000000000033', handle: 'pham-van-hung', display_name: 'Phạm Văn Hùng', first_name: 'Hùng', surname: 'Phạm', gender: 1, generation: 4, is_living: true, birth_year: 1950, biography: 'Con thứ ông Tài.', privacy_level: 0, is_patrilineal: true },
    { id: 'bbbbbbbb-0034-4000-b000-000000000034', handle: 'pham-thi-phuong', display_name: 'Phạm Thị Phượng', first_name: 'Phượng', surname: 'Phạm', gender: 2, generation: 4, is_living: true, birth_year: 1947, biography: 'Con gái ông Đức.', privacy_level: 0, is_patrilineal: true },
    // Đời 5: 3 chút (còn sống)
    { id: 'bbbbbbbb-0041-4000-b000-000000000041', handle: 'pham-van-an', display_name: 'Phạm Văn An', first_name: 'An', surname: 'Phạm', gender: 1, generation: 5, is_living: true, birth_year: 1975, biography: 'Con ông Minh. Kỹ sư CNTT.', privacy_level: 0, is_patrilineal: true, occupation: 'Kỹ sư phần mềm' },
    { id: 'bbbbbbbb-0042-4000-b000-000000000042', handle: 'pham-thi-binh', display_name: 'Phạm Thị Bình', first_name: 'Bình', surname: 'Phạm', gender: 2, generation: 5, is_living: true, birth_year: 1978, biography: 'Con gái ông Minh.', privacy_level: 0, is_patrilineal: true, occupation: 'Giáo viên' },
    { id: 'bbbbbbbb-0043-4000-b000-000000000043', handle: 'pham-van-cuong', display_name: 'Phạm Văn Cường', first_name: 'Cường', surname: 'Phạm', gender: 1, generation: 5, is_living: true, birth_year: 1980, biography: 'Con ông Hùng.', privacy_level: 0, is_patrilineal: true, occupation: 'Bác sĩ' },
  ];

 ...
 * @file src/app/(main)/youtube/youtube-content.tsx
 * @description Client component for YouTube channel page with sidebar menu
 * @version 1.1.0
 * @updated 2026-07-27
 */
...
import { 
  ...
  Award, Calendar, Landmark, Check, BookOpen, Film 
} from 'lucide-react';
...
export function YoutubeContent() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-10 text-slate-100">
      {/* Top Banner Header */}
      <div className="relative rounded-3xl overflow-hidden bg-gradient-to-r from-red-950 via-slate-900 to-amber-950 border border-red-500/30 p-6 sm:p-10 shadow-2xl">

...
import { Plus, Pencil, Trash2, Trophy, Star, ArrowLeft } from 'lucide-react';
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <Input value={awardedBy} onChange={e => setAwardedBy(e.target.value)} placeholder="Sở GD&ĐT Đà Nẵng" />
      </div>
      <div>
        <Label>Mô tả</Label>
